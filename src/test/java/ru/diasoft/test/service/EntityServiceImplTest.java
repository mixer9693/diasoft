...
import ru.diasoft.test.MockData;
...
class EntityServiceImplTest {
    ...
    void getContactByIdWithValidParam(){
        Contact contact = contactEntityService.getById(MockData.CONTACT_1_ID);
    ...
    void saveContactWithValidData(){
        ...
        person.setId(MockData.PERSON_ID);

        ContactType contactType = new ContactType();
        contactType.setId(MockData.CONTACT_TYPE_ID);
    ...
    void saveExistingContact(){
        ...
        Contact contact = new Contact();
        contact.setId(MockData.CONTACT_1_ID);
    ...
    void updateContactWithValidParams(){
        ...
        try{
            updatedContact = contactEntityService.getById(MockData.CONTACT_1_ID);
    ...
    void updateContactWithInvalidParams(){
        ...
        detachedContact.setId(MockData.CONTACT_1_ID);
    ...
    void removeContactWithValidParams(){
        Contact contact = contactEntityService.getById(MockData.CONTACT_2_ID);
        contactEntityService.remove(contact);

        Contact removedContact = null;
        try {
            removedContact  = contactEntityService.getById(MockData.CONTACT_2_ID);
        }catch (Exception e){
            fail("Method execution aborted due to error getting contact: " + e.getMessage());
        }
    ...
    void removeContactWithInvalidParams(){
        Contact contact = new Contact();
        contact.setId(MockData.CONTACT_2_ID);
        assertThrows(PersistenceException.class, () -> {
           contactEntityService.remove(contact);
        });
    }
